    ...
    state = {
        work: [{
            ...
            description: 'Work with API, server, promises, middleware, connect,' +
                ' mdtp, mstp, compose, withRouter, Reselect, HOOK, useState, UseEffect',
            icon: project1,
            ...
            id: 1,
            name: 'Counter Value',
            description: 'Use ECMAScript and React, new features, function declaration, expressions, callbacks, string templates',
            icon: project2,
            ...
            id: 2,
            name: 'Redux Thunk',
            description: 'ToDoList, created with use createReducer, actions, creators, Redux-Dux, Provider, Context, Class Component, Life-Cycle-Methods',
            icon: project3,
